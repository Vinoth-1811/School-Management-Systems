                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms calendar-icon">
                                            ...
                                            <input class="form-control datetimepicker @error('date_of_birth') is-invalid @enderror" name="date_of_birth" type="text" value="{{ $studentEdit->date_of_birth }}">
                                            @error('date_of_birth')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    {{-- <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select @error('department') is-invalid @enderror" name="department">
                                                ...
                                                <option value="A" {{ $studentEdit->department == 'A' ? "selected" :""}}>A</option>
                                                <option value="B" {{ $studentEdit->department == 'B' ? "selected" :""}}>B</option>
                                                <option value="C" {{ $studentEdit->department == 'C' ? "selected" :""}}>C</option>
                                            </select>
                                            @error('department')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select @error('department') is-invalid @enderror" name="department">
                                                ...
                                                @foreach ($departmentList as $department)
                                                    <option value="{{ $department->id }}" {{ $studentEdit->department == $department->id ? 'selected' : '' }}>
